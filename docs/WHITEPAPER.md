...
| The loop | relaxation α / tolerance | 0.55 / 0.012 | the iterate-to-fixed-point map $g \leftarrow g + \alpha(E(R(B(g)))-g)$ (read the picture back through the brain) |
| The loop | read-back probes $F$ | 24 | picture samples fed back through the brain (read-back resolution) |
