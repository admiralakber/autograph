...
export const PARAMS: readonly ParamSpec[] = [
  ...
  { key: 'glimpseRes', label: 'glimpse grid res', value: 24, group: 'Substrate (ES-HyperNEAT)', note: 'v6 Phase 4 — resolution of the static-image grid (res×res, z=0 slice) the attention rollout renders once, then glimpses by interpolation. Higher = finer image the brain can read, but a heavier one-off render (the perf-hardening phase caches/parallelises this). See docs/notes/v6-temporal-brain.md.' },
